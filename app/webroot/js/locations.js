function define_show_hide_image_retired(value_comparator_separator, show_label, hide_label){
        var current= $("#FiltersLocationsLocationRetired").val();
        var qtip_content;
        var qtip_color;
        //is visible
...
function show_hide_retired_locations(button, parent_div, url_base, value_comparator_separator, show_label, hide_label)
{
        var current= $("#FiltersLocationsLocationRetired").val();
        var qtip_content;
        var qtip_color;
        ...
        //is visible, so hide
        if(current=="" || current==("1"+value_comparator_separator+"equal")){
                $("#FiltersLocationsLocationRetired").val("0"+value_comparator_separator+"equal"); 
                ...
                $("#FiltersLocationsLocationRetired").val("");
