...
var getFileInfo = function(file){
	...
	if(window.opener != null && can_upload == true) template += '<button id="select" name="select" type="button" value="Select">' + lg.select + '</button>';
	if(can_download == true) template += '<button id="download" name="download" type="button" value="Download">' + lg.download + '</button>';
	if(can_rename == true) template += '<button id="rename" name="rename" type="button" value="Rename">' + lg.rename + '</button>';
	if(can_remove == true) template += '<button id="delete" name="delete" type="button" value="Delete">' + lg.del + '</button>';
...
$(function(){
	...
	if(can_upload == false) $('#newfile').remove();
	if(can_upload == false) $('#upload').remove();
	if(can_create == false) $('#newfolder').remove();
	if(can_rename == false) $('#toolbar').remove('#rename');
	if(can_rename == false) $('.contextMenu .rename').remove();
	if(can_remove == false) $('.contextMenu .delete').remove();
