...
/* PRIVATE METHODS ***************************************************************************** */
	...
	function _viewHeader() {
		...
		if($this->FileManager->enableUpload && $this->searchString == '') {  // Added --------- DARIO ----------- //
			print "{name:'saveFromUrl.gif',width:11,height:14,dialog:'fmSaveFromUrl',caption:'" . addslashes(FM_Tools::getMsg('cmdSaveFromUrl')) . "',style:'cursor:pointer'},";  // Added --------- DARIO ----------- //
		}  // Added --------- DARIO ----------- //
		else if(!$this->FileManager->hideDisabledIcons) {  // Added --------- DARIO ----------- //
			$error = addslashes(FM_Tools::getMsg('cmdSaveFromUrl') . ': ' . FM_Tools::getMsg('errDisabled'));  // Added --------- DARIO ----------- //
			print "{name:'new_x.gif',width:11,height:14,dialog:'fmError',caption:['" . addslashes(FM_Tools::getMsg('error')) . "', '$error'],style:''},";  // Added --------- DARIO ----------- //
		}  // Added --------- DARIO ----------- //
		...
		if($this->FileManager->enableUpload && $this->searchString == '') {
			...
			//print "{name:'saveFromUrl.gif',width:11,height:14,dialog:'fmSaveFromUrl',caption:'" . addslashes(FM_Tools::getMsg('cmdSaveFromUrl')) . "',style:'cursor:pointer'}";  // --------- DARIO ----------- //
		}
		else if(!$this->FileManager->hideDisabledIcons) {
			...
			//print "{name:'new_x.gif',width:11,height:14,dialog:'fmError',caption:['" . addslashes(FM_Tools::getMsg('error')) . "', '$error'],style:''}";  // --------- DARIO ----------- //
		}
		print '],entries:{';
	}
