...
class AutoEmbed {
  ...
  /*
   * get thumbnail of video (youtube, vimeo)
   */
	public function getThumbnail()
	{
		...
		switch($this->_stub['title'])
		{
			case 'YouTube':
				$return = "<img src='http://img.youtube.com/vi/$id/default.jpg' width='$width' height='$height' />";
				break;
			case 'Vimeo':
				$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/$id.php"));
				$thumb = $hash[0]['thumbnail_medium'];
				$return = "<img src='$thumb' width='$width' height='$height' />";
				break;
		}
		return $return;
	}
