...
<?php echo $this->Form->create($model, array('type' => 'file'));?>
	...
	<?php echo $this->Form->input($model.'.telefono_secundario', array('size' => '50'));?>
	<?php echo $this->Form->input($model.'.telefono_emergencia', array('size' => '50'));?>
	<?php echo $this->Form->input($model.'.fax', array('size' => '50'));?>
