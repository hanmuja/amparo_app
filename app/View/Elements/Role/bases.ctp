...
<div id="tr_base_folder" style="display:none" serial="<?php echo $serial?>">
        <table>
                <?php
                        ...
                        $tr[]= $this->Form->input("Role.REPLACEME.DefaultFolders.folder", array("label"=>false, 'type' => 'hidden', 'div' => array('class' => 'input text two_column'))).
                        	$this->Form->label("Role.REPLACEME.DefaultFolders.folder", "", array('id' => 'RoleREPLACEMEDefaultFoldersFolder_label'));
