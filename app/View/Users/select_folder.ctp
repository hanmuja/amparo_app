...
setTimeout(function() { 
		...
		var input_val = $("#User"+"<?php echo $i ?>"+"DefaultFoldersFolder").val();
		
		var id = input_val.replace(/\//g, '_');
...
function select_folder()
{
	...
	add_folder_row('<?php echo __('Remove Row') ?>', 'new_folder_table', 'tr_base_folder', value, '<?php echo SHORTCUTS_DIALOG_DIV ?>', <?php echo $i != null ? $i : 'false' ?> );
}
